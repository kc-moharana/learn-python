...
# A Good First Program: Hello world
...
# Getting help : help()
+ On python interactive shell type: help()
...
accessed by the __doc__ attribute of the object.

> On Interactive shell: ambiguous_dna_alphabet.__doc__
...
it can be done using comma(,) and plus (+).
